...
const RUNTIME_CACHE = 'password-generator-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/password-generator/',
  '/password-generator/manifest.json',
  '/password-generator/icon-192.png',
  '/password-generator/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/password-generator/manifest.json';
}
