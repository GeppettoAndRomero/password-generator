...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/password-generator/sw.js, scope=/password-generator/）。
    // scope がツールの全 locale ページ（/password-generator/, /password-generator/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/password-generator/sw.js', {
