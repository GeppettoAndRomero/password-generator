...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      // Scope to the genuinely unit-testable module: the whole engine is pure
      // functions over crypto.getRandomValues, with no DOM/integration
      // dependency, so it belongs fully in the unit-coverage gate.
      include: ['src/lib/passwordEngine.ts'],
